        ...
        <div className="flex flex-col lg:flex-row lg:justify-between sm:gap-10 xs:gap-10 lg:items-center  lg:gap-100">
          ...
          <div className="flex-1 w-full lg:max-w-md">
            <div className="flex flex-row items-center bg-white rounded-full shadow-sm overflow-hidden px-1">
              ...
              <button
                type="submit"
                className="px-4 py-2 md:px-6 md:py-3 bg-[#BE9B81] text-white text-sm font-medium font-montserrat m-2 rounded-full transition-all duration-300 hover:bg-[#a67f67] hover:shadow-lg cursor-pointer"
              >
                Subscribe
              </button>
            </div>
